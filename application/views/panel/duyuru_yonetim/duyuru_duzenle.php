<div class="block-header">
    <ol class="breadcrumb breadcrumb-col-cyan">
	    ...
	    <li class="active"><i class="material-icons">edit</i>Duyuru Düzenle</a></li>
	</ol>
</div>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
			...
			<form action="<?php echo base_url("panel/duyuru_yonetim/duyuru_guncelle/$duyuru->duyuruId") ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
					<div class="form-group">
					 	<div class="form-line"> 
							<label class="control-label">Duyuru Başlık</label> 
							<input type="text" class="form-control" name="duyuruBaslik" placeholder="örn:Web sitemiz yayınlandı" value="<?php echo $duyuru->duyuruBaslik ?>" required=""> 
						</div>
					</div>
					<div class="form-group"> 
						<label class="control-label">Duyuru Anasayfada Gösterilsin mi ?</label> 
					 	<div class="switch">
                            <label>Hayır<input type="checkbox" <?php echo $duyuru->duyuruDurum == 1 ?'checked':'' ?> name="duyuruDurum"><span class="lever"></span>Evet</label>
                        </div>
					</div>
					...
					<div class="form-group">
						...
						<textarea id="tinymce" name="duyuruIcerik"> <?php echo $duyuru->duyuruIcerik ?></textarea>
