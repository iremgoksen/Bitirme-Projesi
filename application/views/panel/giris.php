...
<div class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="http://www.ofosoft.com" target="_blank"><b>OfoSoft</b></a>
            <small>Web tasarım Web App</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?php echo base_url(); ?>panel/giris_yonetim/giris">
                    <div class="msg">Yönetim Paneli</div>
