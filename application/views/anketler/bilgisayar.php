<div class="quiz_form"> 
                  ...
                  <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                          ...
                          <?php $soruSirasi++;} ?>
                          <button class="button-default devamUygunluk" value="1" tip="1">
                            Anketi Tamamla
                          </button>
                        </div>
                    </div>
       ...
       <?php 
            $this->session->set_userdata("bilgisayar",json_encode($soruIdler));
        ?>
...
<script type="text/javascript">
  if(parseFloat(localStorage.muhendislikSim) < 0.5 || localStorage.muhendislikSim == undefined){
        alert("Mühendislik Anketini Başarılı Bir Şekilde Tamamlamalısınız");
