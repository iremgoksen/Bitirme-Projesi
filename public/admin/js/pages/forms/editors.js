...
$(function () {
    ...
    tinymce.init({
        ...
        selector: "textarea#tinymce",theme: "modern",height: 400,
        plugins: [
       ...
       convert_urls : true,
       language :   "tr_TR",
       external_filemanager_path:"public/admin/uploads/filemanager/",

       filemanager_title:"Ofosoft Dosya Yöneticisi" ,
       external_plugins: { "filemanager" : tinyMCE.baseURL+ "/plugins/responsivefilemanager/plugin.min.js"},
        ...
        file_picker_types:'file image media',file_picker_callback:function(cb,value,meta){
            ...
            if(width>600){
                ...
                var title="Ofosoft Dosya Yöneticisi";
